...
pathsave = "/home/hunter/nguyenthieu95/ai/6_google_trace/SVNCKH/testing/5m/ann/result/cpu/"
                ...
                for couple_act in couple_acts:
                    for optimizer in optimizers:
                        for learning_rate in learning_rates:
                            ...
                            my_model = ann.Model(dataset_original, list_num5, epoch, batch_size, sliding, method_statistic, output_index, num_hidden,
