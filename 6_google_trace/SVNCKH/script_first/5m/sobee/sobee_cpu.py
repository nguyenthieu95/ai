...
pathsave = "/home/hunter/nguyenthieu95/ai/6_google_trace/SVNCKH/testing/5m/sobee/result/cpu/"
...
df = read_csv(fullpath+ filename5, header=None, index_col=False, usecols=[3], engine='python')
