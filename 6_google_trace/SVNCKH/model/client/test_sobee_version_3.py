...
class Model(object):
    ...
    def train_bee(self):
        ...
        bee_para = {
            "max_gens": self.max_gens, "num_bees": self.num_bees, "limit": self.limit,
            "SR": SR, "NP_min": NP_min, "NP_threshold": NP_threshold,
            "SSP_min": SSP_min, "SSP_max": SSP_max,
            "lowup_w": self.low_up_w, "lowup_b": self.low_up_b
        }
        other_para = {
