...
pathsave = "/home/hunter/nguyenthieu95/ai/6_google_trace/SVNCKH/testing/8m/sopso/result/ram/"
                ...
                for max_move in max_moves:
                    for pop_size in pop_sizes:
                        for c_couple in c_couples:
                            ...
                            my_model = sopso.Model(dataset_original, list_num8, output_index, sliding, method_statistic, max_cluster,
