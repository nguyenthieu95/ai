...
pathsave = "/home/hunter/nguyenthieu95/ai/6_google_trace/SVNCKH/testing/8m/sobee/result/ram/"
...
df = read_csv(fullpath+ filename8, header=None, index_col=False, usecols=[4], engine='python')
...
stimulation_levels = [0.2]  # [0.10, 0.25, 0.45]
distance_levels = [0.75] # [0.65, 0.75, 0.85]

list_max_gens = [360, 650, 1000]  # epoch
list_num_bees = [30]  # number of bees - population
