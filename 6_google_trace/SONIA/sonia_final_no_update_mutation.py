            ...
            for batch_size in batch_sizes:
                ...
                for learning_rate in learning_rates:
                    ...
                    for positive_number in positive_numbers:
                        ...
                        testX = data[400:800-sliding]
                        testY = GoogleTrace_orin_unnormal[400+sliding:800]
...
#                        trainX, trainY = data[0:2200], data[sliding:2200+sliding, 0:1]
#                        testX = data[2200:2500-sliding]
#                        testY = GoogleTrace_orin_unnormal[2200+sliding:2500]
