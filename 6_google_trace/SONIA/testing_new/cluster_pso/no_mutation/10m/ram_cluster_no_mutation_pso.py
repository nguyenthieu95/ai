...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr  7 09:44:41 2018
...
class Model(object):
    def __init__(self, dataset_original, list_idx, pso_param, sliding, positive_number, sti_level, method_statistic = 0, activation=0):
        ...
        self.filenamesave = "point-slid_{0}-method_{1}-pos_{2}-sti_{3}-pop_size_{4}-move_count_{5}-c1_{6}-c2_{7}-activ_{8}".format(sliding, method_statistic, positive_number, sti_level, pso_param[0], pso_param[1], pso_param[6], pso_param[7], activation)
...
pathsave = "/home/hunter/nguyenthieu95/ai/6_google_trace/SONIA/testing_new/cluster_pso/no_mutation/10m/result/ram/"
fullpath = "/home/hunter/nguyenthieu95/ai/data/GoogleTrace/"
#filename = "data_resource_usage_tenMinutes_6176858948.csv"
filename = "Fuzzy_data_sampling_617685_metric_10min_datetime_origin.csv"

#pathsave = "/home/thieunv/university/LabThayMinh/code/6_google_trace/SONIA/testing_new/cluster_pso/no_mutation/10m/result/ram/"
#fullpath = "/home/thieunv/university/LabThayMinh/code/data/GoogleTrace/"
#filename = "data_resource_usage_tenMinutes_6176858948.csv"

df = read_csv(fullpath+ filename, header=None, index_col=False, usecols=[1], engine='python')   
dataset_original = df.values

stimulation_levels = [0.05, 0.10, 0.15, 0.25, 0.35, 0.45]  #[0.10, 0.2, 0.25, 0.50, 1.0, 1.5, 2.0]  # [0.20]    
                        ...
                        for pop_size in pop_sizes:
                            for move_count in move_counts:
                                for c_id in c_couple:
                                    ...
                                    febpnn = Model(dataset_original, list_idx, pso_param, sliding, positive_number, sti_level, method_statistic, acti)
                                    febpnn.fit()
