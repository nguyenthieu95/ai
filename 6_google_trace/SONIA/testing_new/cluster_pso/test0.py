...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr  7 08:48:53 2018
...
stimulation_levels = [0.40]  #[0.10, 0.2, 0.25, 0.50, 1.0, 1.5, 2.0]  # [0.20]    
...
move_counts = [20]     # So lan di chuyen` 
                            ...
                            for pop_size in pop_sizes:
                                for move_count in move_counts:
                                    for c_id in c_couple:
                                        ...
                                        if sliding >= 3 and sti_level <= 0.25:
                                            continue
