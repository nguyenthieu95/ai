...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  2 09:38:41 2018
...
class Model(object):
    def __init__(self, dataset_original, list_idx, epoch, batch_size, sliding, learning_rate, positive_number, stimulation_level, dis_level, method_statistic = 1):
