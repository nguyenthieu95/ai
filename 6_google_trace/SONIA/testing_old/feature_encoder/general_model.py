...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  2 02:57:25 2018
...
#                matrix_Wih = np.transpose(matrix_Wih)
    ...
    def transform_features(self):
        ...
        for i in range(0, len(self.X_train)):  
            ...
            for j in range(0, len(self.matrix_Wih)):     # (w11, w21) (w12, w22), (w13, w23)
                Sih.append(np.tanh(sqrt(FeBpnnModel.distance_func(self.matrix_Wih[j], self.X_train[i]))))
    ...
    def build_bpnn_and_train_2(self):
        ## Build layer's sizes
        X_train = self.S_train
        y_train = self.y_train
#        X_test = self.S_test
