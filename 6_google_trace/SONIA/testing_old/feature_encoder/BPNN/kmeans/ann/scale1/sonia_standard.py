...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar  3 02:42:06 2018

@author: thieunv

*) GradientDescentOptimizer (MinMaxScaler - 1)

    elu / relu/ tanh/ sigmoid ===> failed/ failed / 0.48 / failed
...
*) AdagradOptimizer   
     ...
     elu / relu/  tanh/  sigmoid ===> failed/ failed / 0.47 / failed

*) AdadeltaOptimizer
    
     elu / relu/ tanh/ sigmoid ===> 0.53/ failed / 0.45 / failed
...
epochs = [3000] #[100, 250, 500, 1000, 1500, 2000]   # [500]                       
