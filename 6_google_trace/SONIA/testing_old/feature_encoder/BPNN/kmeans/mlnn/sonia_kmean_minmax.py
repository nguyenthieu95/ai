...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar  3 03:03:21 2018

@author: thieunv

*) GradientDescentOptimizer (MinMaxScaler - 2)

    elu +  elu / relu/ tanh/ sigmoid ===> failed/ failed / 0.38 / failed
    relu + elu / relu / tanh/ sigmoid ===>  0.58/ failed/ 0.50 /failed
...
*) AdagradOptimizer   
     ...
     elu + elu / relu/  tanh/  sigmoid ===> 0.39 / failed / 0.46 / failed
