...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  6 15:39:03 2018
...
*) AdamOptimizer 
     ...
     elu / relu/ tanh/ sigmoid ===> 0.50 (figure good looking)/ failed / failed / failed
    
*) AdagradOptimizer   
    
     elu / relu/  tanh/  sigmoid ===> 0.49/ failed / 0.54 / 

*) AdadeltaOptimizer
    
     elu / relu/ tanh/ sigmoid ===> 0.38/ failed / failed / failed
...
positive_numbers = [0.10] #[0.005, 0.01, 0.025, 0.05, 0.1, 0.15, 0.20]     # [0.1]   
learning_rates = [0.10] #[0.005, 0.01, 0.025, 0.05, 0.10, 0.12, 0.15]   # [0.25]    
