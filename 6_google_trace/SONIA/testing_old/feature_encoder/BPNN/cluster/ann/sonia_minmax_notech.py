...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  6 13:33:36 2018
...
*) AdagradOptimizer   
     ...
     elu / relu/  tanh/  sigmoid ===> 0.55/ failed / 0.50 / failed

*) AdadeltaOptimizer
    
     elu / relu/ tanh/ sigmoid ===> 0.41/ 0.43 (good) / 0.5 / failed
    ...
    def encoder_features(self):
        ...
        while m < len(train_X):
            ...
            if distmc < stimulation_level:
                ...
                hic = exp( -distmc*distmc / 2)
                lamda = positive_number * hic
...
positive_numbers = [0.05] #[0.005, 0.01, 0.025, 0.05, 0.1, 0.15, 0.20]     # [0.1]   
