...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 18 01:45:56 2018
    ...
    def encoder_features(self):
        ...
        while m < len(train_X):
            ...
            if distmc < stimulation_level:
                ...
                neighbourhood_node = int( 1 + ceil( 0.3 * (len(list_hu) - 1) ) )
...
file_name = "twoMinutes_6176858948_notNan.csv"
...
df = read_csv(full_path_name+ file_name, header=None, index_col=False, usecols=[5], engine='python')   
dataset_original = df.values

stimulation_level = [0.45]  #[0.10, 0.2, 0.25, 0.50, 1.0, 1.5, 2.0]  # [0.20]    
