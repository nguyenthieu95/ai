...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  2 09:16:16 2018
@author: thieunv

*) GradientDescentOptimizer (MinMaxScaler - 2)

    elu +  elu / relu/ tanh/ sigmoid ===> 0.58/ failed / 0.37 / failed
    relu + elu / relu / tanh/ sigmoid ===>  0.49/ failed/ 0.52 (nhin hinh rat dep) /failed
...
*) AdagradOptimizer   
     ...
     elu + elu / relu/  tanh/  sigmoid ===> 0.55 / failed / 0.45 / failed

*) AdadeltaOptimizer
    
     elu + elu / relu/ tanh/ sigmoid ===> failed/ failed / 0.48 / failed
...
positive_numbers = [0.0005] #[0.005, 0.01, 0.025, 0.05, 0.1, 0.15, 0.20]     # [0.1]   
