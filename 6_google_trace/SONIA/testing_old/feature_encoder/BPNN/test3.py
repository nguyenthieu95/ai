...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 28 15:09:29 2018
...
*) GradientDescentOptimizer, AdamOptimizer, AdagradOptimizer
...
#        del trace_back_list_hu
    ...
    def predict(self):
        ...
        with tf.Session() as sess:
            sess.run(init)
            y_est_np = sess.run(y_, feed_dict={X: X_test})
...
positive_numbers = [0.0002] #[0.005, 0.01, 0.025, 0.05, 0.1, 0.15, 0.20]     # [0.1]   
...
batch_sizes = [8] #[8, 16, 32, 64, 128]      # [16]     
list_num = [(2800, 4170)]
