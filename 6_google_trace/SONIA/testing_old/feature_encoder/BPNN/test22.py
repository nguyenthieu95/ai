...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  2 10:12:06 2018
...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 28 14:51:49 2018
...
- Activation: elu, tanh/ relu, tanh/ tanh, tanh/ sigmoid, tanh ==> MSE: 
- Activation: elu, sigmoid/ relu, sigmoid/ tanh, sigmoid/ sigmoid, sigmoid ==> MSE: 

    sigmoid, sigmoid/ sigmoid, elu/ sigmoid, relu/ sigmoid, tanh => failed
    
    tanh, tanh/ tanh, elu/ tanh, relu/ tanh, sigmoid => failed
...
file_name = "wc98_workload_min.csv"
...
dataset_original = df.values[1:]

stimulation_level = [1.5]  #[0.10, 0.2, 0.25, 0.50, 1.0, 1.5, 2.0]  # [0.20]    
