...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 27 11:02:02 2018
...
- Activation: sigmoid, relu/ Tanh, Relu / Relu, Relu / Elu, Relu / ==> MSE: Failed / 0.38 / 0.36 (co ve la tot nhat)  
    
- Activation: Elu, Sigmoid/ Relu, Sigmoid / Tanh, Sigmoid/ Sigmoid, sigmoid/ ...  => MSE : Failed
    + Loss se giam nhanh theo tung epoch
    
- Activation: Elu, Elu/ Relu, Elu/ Tanh, Elu/ Sigmoid, Elu ==> MSE: 0.37/ Failed/ failed/ failed
...
- Activation: elu, tanh/ relu, tanh/ tanh, tanh/ sigmoid, tanh   => MSE: Failed/ 0.34 (cam giac thay failed) / 0.39/0.40 (tot nhat tu truoc den gio)
...
class Model(object):
    ...
    def build_model_and_train(self):
        ...
        hidden_out3 = tf.nn.relu( tf.add(tf.matmul(hidden_out2, W3), b3) )
