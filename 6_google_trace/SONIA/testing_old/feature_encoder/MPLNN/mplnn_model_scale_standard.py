...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 27 10:24:57 2018
...
- Activation: Elu, Elu / relu, elu/ tanh, elu ==> MSE: 0.42/ 0.38/ 0.41 (tot hon Relu,Relu)
...
class Model(object):
    ...
    def build_model_and_train(self):
        ...
        hidden_out1 = tf.nn.tanh( tf.add(tf.matmul(X, W1), b1) )
        hidden_out2 = tf.nn.tanh( tf.add(tf.matmul(hidden_out1, W2), b2) )
        hidden_out3 = tf.nn.tanh( tf.add(tf.matmul(hidden_out2, W3), b3) )
