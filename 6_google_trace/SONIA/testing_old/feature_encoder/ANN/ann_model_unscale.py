...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 23 09:06:40 2018

@author: thieunv
- ANN using tensorflow, unscale input data
"""
...
#            y_test_inverse = my_invert_min_max_scaler(y_test, self.min_GT, self.max_GT)
#            y_pred_inverse = my_invert_min_max_scaler(y_est_np, self.min_GT, self.max_GT)
            y_test_inverse = y_test
            y_pred_inverse = y_est_np
