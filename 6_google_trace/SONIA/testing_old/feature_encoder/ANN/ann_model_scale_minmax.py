...
- Activation: Relu, Relu  => MSE : 0.42
    + Loss se giam nhanh theo tung epoch
    
- Activation: Relu, Sigmoid / Sigmoid, Relu => MSE : 0.67 / 0.57
    + Loss giam rat tu tu, da~n den cac gia tri ~ nhau -> Error
    
- Activation: Sigmoid, Sigmoid ===> Failed

- Activation: Elu, Elu ==> MSE: 0.41 (tot hon Relu,Relu)

- Activation: Relu, Elu ==> 0.43 
