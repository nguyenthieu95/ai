...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 26 18:03:41 2018

@author: thieunv
- ANN using tensorflow, This is the neuron network with right way using pre-proccessing data
...
- Activation: Elu, Elu/ Relu, Elu/ Tanh, Elu/ Sigmoid, Elu ==> MSE: 0.39/ 0.39/ 0.38/ 0.37
...
- Activation: elu, tanh/ relu, tanh/ tanh, tanh/ sigmoid, tanh   => MSE: 0.39/ 0.37/ 0.40/0.35 (tot nhat tu truoc den gio)
