...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 18 14:38:34 2018
...
full_path = "/home/thieunv/university/LabThayMinh/code/6_google_trace/SONIA/testing/ga/no_update/result/cpu/"
...
def build_hidden_layer(train_X):
...
def mySONIA(train_X, train_y, test_X, epoch, batch_size, validation,sliding, learning_rate = 0.01, 
    ...
    ### Build hidden layer (weight input and hidden)
    sorted_matrix_Wih, sorted_list_hu = build_hidden_layer(train_X)
    
    ### Build output layer (weight hidden and output using GA)
