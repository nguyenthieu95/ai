...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 17 22:28:52 2017
...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 16 15:37:06 2017
...
full_path = "/home/thieunv/university/LabThayMinh/code/6_google_trace/SONIA/results/mutation/notDecompose/data10minutes/univariate/cpu/"
df = read_csv(full_path_name+ file_name, header=None, index_col=False, usecols=[0], engine='python')   
dataset_original = df.values


distance_level = 0.2                     # [0.1, 0.15, 0.2]
threshold_number = 150   # 50 example                #[2, 3, 4]

stimulation_level = [0.20]                                # [0.10, 0.12, 0.15, 0.20]  # [0.20]    
positive_numbers = [0.07]                         # [0.01, 0.03, 0.05, 0.10]     # [0.1]   

learning_rates = [0.03]                   #[0.01, 0.03, 0.05, 0.10, 0.12, 0.15, 0.20]   # [0.2]    
sliding_windows = [3]                      # [1, 2, 3, 5]           # [3]  
     
epochs = [200]                     #   [1000, 1500, 2000, 2500]   # [500]                       
...
#                        trainX, trainY = data[0:400], data[sliding:400+sliding, 0:1]
#                        testX = data[400:500-sliding]
#                        testY = GoogleTrace_orin_unnormal[400+sliding:500]
                #        len(testY): 1, len(testPredict): 97, 8 hidden unit
                #        Test Score: 0.587956 RMSE
                #        Test Score: 0.369269 MAE
                #        
                ...
                #        len(testY): 1, len(testPredict): 97 , 5 hiddent unit
                #        Test Score: 1.387020 RMSE
                #        Test Score: 0.788447 MAE
                        
                        trainX, trainY = data[0:3500], data[sliding:3500+sliding, 0:1]
                        testX = data[3500:3600-sliding]
                        testY = GoogleTrace_orin_unnormal[3500+sliding:3600]
