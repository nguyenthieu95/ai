...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 19 02:56:55 2018
...
### SimpleRoomEnv Environment
class SimpleRoomsEnv(Environment):
    """Define a simple 4-room env (top - left, right. button - left,right)
    actions: 0-north (Bac), 1-east(Dong), 2-west(Tay), 3-south(Nam)
    """
    ...
    def __init__(self):
        ...
        self.max_trajectory_length = 50     # Chieu dai max cua quy~ dao
        self.tolerance = 0.1                # Long khoan dung 
        self._rendered_maze = self._render_maze()   # Me cung
    ...
    def render(self, mode = 'rgb_array'):
        assert mode == 'rgb_array', 'Unknow mode: %s' % mode
