...
from utils.Setting import tn1_requirement_variables_multi_ram as requirement_variables
from utils.Setting import server_tn1_param_grid_ga as param_grid
