...
for i in range(0, len(data)):
    ...
    # GradientDescentOptimizer, AdamOptimizer (0100), AdagradOptimizer, AdadeltaOptimizer

    sliding_windows = [2, 3, 5]
    positive_numbers = [0.05, 0.15, 0.25]
    stimulation_levels = [0.25, 0.35, 0.5]
    distance_levels = [0.40, 0.50, 0.65]
                        ...
                        for num_bees in list_num_bees:
                            for couple_bees in list_couple_bees:
                                ...
                                model_name = "_sliding=" + str(sliding) + "_posNumber=" + str(pos_number) + \
                                             ...
                                             "_maxGens=" + str(max_gens) + "_numBees=" + str(
                                    num_bees) + "_coupleBees=" + str(couple_bees)
