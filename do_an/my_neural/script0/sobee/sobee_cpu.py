...
for i in range(0, len(data)):
    pathsave = os.path.dirname(__file__) + "/result/" + str(data[i]) + "m/cpu/"
    fullpath = "/home/hunter/nguyenthieu95/ai/data/GoogleTrace/"
    filename = "data_resource_usage_" + str(data[i]) + "Minutes_6176858948.csv"
    filesave_model = os.path.dirname(__file__) + "/result/" + str(data[i]) + "m/cpu.txt"
    ...
    distance_levels = [0.35, 0.55, 0.75]

    list_max_gens = [600, 750, 900]  # epoch
