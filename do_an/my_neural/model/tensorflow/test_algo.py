...
for i in range(0, len(data)):
    pathsave = "/home/thieunv/university/LabThayMinh/code/6_google_trace/SVNCKH/script3/test3/result/" + str(data[i]) + "m/cpu/"
    ...
    list_max_gens = [2000, 3000]  # epoch
    list_num_bees = [200]  # number of bees - population
    list_couple_bees = [(15, 3)]  # e_bees, o_bees
                    ...
                    for max_gens in list_max_gens:
                        for num_bees in list_num_bees:
                            for couple_bees in list_couple_bees:
                                ...
                                my_model = SOBEE(para_data, para_net, para_bee)
                                my_model.fit()
                                so_vong_lap += 1
                                fig_id += 2
