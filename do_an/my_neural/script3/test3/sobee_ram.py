...
for loop in range(0, number_run_test):
    ...
    for i in range(0, len(data)):
        pathsave = "/home/hunter/nguyenthieu95/ai/do_an/my_neural/script3/test3/result/" + str(data[i]) + "m/ram/"
        fullpath = "/home/hunter/nguyenthieu95/ai/data/GoogleTrace/"
        filename = "data_resource_usage_" + str(data[i]) + "Minutes_6176858948.csv"
        filesave_model = "/home/hunter/nguyenthieu95/ai/do_an/my_neural/script3/test3/result/" + str(data[i]) + "m/ram.txt"
