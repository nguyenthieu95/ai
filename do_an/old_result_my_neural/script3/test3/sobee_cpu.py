...
for loop in range(0, number_run_test):
    ...
    for i in range(0, len(data)):
        pathsave = "/home/hunter/nguyenthieu95/ai/do_an/my_neural/script3/test3/result/" + str(data[i]) + "m/cpu/"
        fullpath = "/home/hunter/nguyenthieu95/ai/data/GoogleTrace/"
        filename = "data_resource_usage_" + str(data[i]) + "Minutes_6176858948.csv"
        filesave_model = "/home/hunter/nguyenthieu95/ai/do_an/my_neural/script3/test3/result/" + str(data[i]) + "m/cpu.txt"
        ...
        list_max_gens = [700]
        list_num_bees = [120]
        list_couple_bees = [(15, 3), (12, 3), (9, 3), (6, 3), (3, 3), (3, 6), (3, 9), (3, 12), (3, 15)]
        num_sites = 3
        elite_sites = 1
        patch_size = 5.0
        patch_factor = 0.97
...
filename_runtest = "/home/hunter/nguyenthieu95/ai/do_an/my_neural/script3/test3/result/"
